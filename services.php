...
<?php
  ...
  if (isset($_GET['search'])) {
    ...
    if (!empty($value)) {
     ...
     $sql="SELECT * FROM users WHERE role='Service Provider' and company LIKE '%$value%' or name like '%$value%'  ;";
    $results =mysqli_query($conn,$sql);
    $users=mysqli_fetch_all($results,MYSQLI_ASSOC);
...
?>
  ...
  <div class="w-100" style="height:10px"></div>
          ...
          <div class="d-flex align-items-center justify-content-end" style="flex:1">
            ...
            <div class="col-lg-4" style="position: relative;">
                <form action="" method="get">
                  <input type="search" name='value'  name='value' value='<?php echo $value ?>' style="outline: none;" autocomplete="off" class="form-control" name="search" placeholder="Search sellers...">
    ...
    <section id="courses" class="courses">
      <div class="container" data-aos="fade-up"><?php echo count($users)<1?'<p class="w-100 text-center">no service providers yet</p>':''  ?>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-stretch" >
            <div class="course-item w-100">
              ...
              <div class="course-content">
                ...
                <h3><a href="course-details.html"><?php echo $user['motto']  ?></a></h3>
                <p><?php echo $user['description']  ?></p>
                <h4>
                  Tell:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span><?php echo $user['contact']  ?></span><br>
                  Location: &nbsp;&nbsp;<span><?php echo $user['location']  ?></span><br>
                  Website:&nbsp;&nbsp;&nbsp; <a href="http://<?php echo $user['website']  ?>" style="color:white;"><span><?php echo $user['website']  ?></span></a>
