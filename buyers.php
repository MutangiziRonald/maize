...
<?php
  ...
  if (isset($_GET['search'])) {
    ...
    $value=$_GET['value'];
      ...
      if (!empty($value)) {
            $sql="SELECT * FROM users WHERE role='buyer' and company LIKE '%$value%' or name like '%$value%' or location like '$value'";
      $results =mysqli_query($conn,$sql);
      $users=mysqli_fetch_all($results,MYSQLI_ASSOC);
          ...
          <div class="d-flex align-items-center justify-content-end" style="flex:1">
            ...
            <div class="col-lg-4" style="position: relative;">
                <form action="" method="get">
                  <input type="search" name='value'  name='value' value='<?php echo $value ?>' style="outline: none;" autocomplete="off" class="form-control" name="search" placeholder="Search buyers...">
...
<p class='w-100 text-center'><?php echo count($users)<1?'no buyers yet':'' ?> </p>
            ...
            <div class="course-item w-100">
              ...
              <div class="course-content">
                ...
                <h4>
                  ...
                  Website:&nbsp;&nbsp;&nbsp; <a href="<?php echo $user['website']  ?>" style="color:white;"><span><?php echo $user['website']  ?></span></a>
      ...
      if (isset($_GET['search'])) {
        if (!empty($value)) {
        $value=$_GET['value'];
      $sql="SELECT * FROM users WHERE role='buyer' and company LIKE '%$value%' or name like '%$value%';";
        $results =mysqli_query($conn,$sql);
        $users=mysqli_fetch_all($results,MYSQLI_ASSOC);
